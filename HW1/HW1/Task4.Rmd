...
# Enter your code here:
library(Biostrings)
file_path <- "C:/Users/Amit_g/Desktop/Bio_HW/HW1/covid_spike_variants.fasta"
# Read the file using readAAStringSet
...
distMat <- dist.alignment(msaConvert(variants.msa, type="seqinr::alignment"))
```
...
ape_complement <- ape::complement
biostrings_complement <- Biostrings::complement
ptree <- bionj(distMat)
```
