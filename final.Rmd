...
write.csv(counts_matrix_normal, "normal.counts_matrix.csv")
```
...
- First We will filter genes based on the LFC value - Log Fold Change
```{r}
# Shrink LFC 
...
### Visualization of gene expression of Normal case 1
...
ggplot(d.1[d.1$count < 200,], aes(tobacco_smoking_status, count)) + 
  ...
  theme(axis.text.x = element_text(size = 8),  # Rotate x-axis labels
        plot.title = element_text(hjust = 0.5))  # Center the plot title
```
We see that the expression of the SYTL5 gene in people who had smoked and stopped is pretty low, while in people who have never smoked it is relatively high (there is a tail of outlieras in both groups, but, as we did in class, we disregard them).
So SYTL5 is upregulated in individuals who have never smoked.
SYTL5 is involved in the regulation of vesicle trafficking, specifically in the context of exocytosis. It plays a role in the movement of vesicles containing proteins and lipids to the cell membrane, where they can be released into the extracellular environment or integrated into the cell membrane.

The elevated expression of SYTL5 in lifelong non-smokers might indicate a protective role in maintaining normal cellular functions and membrane dynamics.
Higher levels of SYTL5 could contribute to the stability and proper functioning of vesicle trafficking systems, ensuring efficient delivery of essential proteins and lipids to the cell membrane.
The downregulation in reformed smokers may reflect lingering effects of smoking on cellular mechanisms, even after cessation.
Reduced levels of SYTL5 might be associated with impaired vesicle trafficking and membrane dynamics, potentially leading to cellular stress or dysfunction.

Conclusion:
The differential expression of SYTL5 between lifelong non-smokers and short-termed reformed smokers suggests that SYTL5 might play a significant role in maintaining normal cellular functions, particularly in vesicle trafficking and membrane dynamics. The elevated expression in non-smokers likely supports effective cellular operations and homeostasis, while the downregulation in reformed smokers may indicate cellular adaptation or residual dysfunction following smoking cessation.
...
GPR15 is involved in immune responses and has been identified as a receptor for various chemokines. It is known for its role in the homing and migration of lymphocytes, particularly to the gut and potentially other mucosal tissues.
GPR15 directs the migration of specific subsets of immune cells to target tissues.
By guiding immune cells, GPR15 influences local immune responses and inflammation.

The upregulation of GPR15 in reformed smokers suggests alterations in immune cell trafficking and potentially heightened immune surveillance or inflammatory responses.
Smoking and its cessation may induce lasting changes in the immune system, and the increased expression of GPR15 could be a marker of such changes.
Lifelong non-smokers may have baseline levels of GPR15 expression that reflect normal immune cell trafficking and a balanced immune response, in contrast, the elevated levels in reformed smokers might indicate residual inflammation or an ongoing immune response as the body adjusts after smoking cessation.

Cobnclusion:
Increased GPR15 expression might lead to enhanced recruitment of immune cells to mucosal tissues, which could be a response to previous damage caused by smoking. Lower expression levels suggest a stable and possibly less active immune cell trafficking compared to reformed smokers.
The upregulation of GPR15 could be associated with a heightened inflammatory state as the body attempts to repair and recover from the effects of smoking.
Lower GPR15 levels are indicative of a more controlled inflammatory response, reflecting an absence of smoking-induced immune activation.
