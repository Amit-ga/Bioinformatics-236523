...
The samples cluster pretty well into two groups corresponding to the smoking status categories, indicating that the gene expression profiles are distinctly different between lifelong non-smokers and short-termed reformed smokers.
...
subset_samples <- sample_order[92:110]
...
subset_samples <- sample_order[41:59]
...
```
we received 0 significant pathways.
